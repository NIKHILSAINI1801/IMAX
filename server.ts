...
app.post("/api/bookings", (req, res) => {
  ...
  // Create UPI Payment QR code for Ishika Rao
  const qrCodeUrl = `https://api.qrserver.com/v1/create-qr-code/?size=250x250&color=052c24&bgcolor=ffffff&data=${encodeURIComponent("upi://pay?pa=7982194414@upi&pn=Ishika%20Rao")}`;
